...
#include "interchange_rows.h"
#include "interchange_cols.h"
#include "identity_matrix.h"
#include "copy_vector.h"


void print_matrix_h(double *X, int m, int n)
{
    int i,j;
    // int idx = 0;
    for (i = 0; i < m; i++)
...
int Hessenberg_Form_Elementary(double *A, double* S, int n)
{
    std::cout << "before Hessenberg_Form_Elementary: (A)\r\n";
    print_matrix_h(A, n, n);
    std::cout << "\r\n";

    std::cout << "before Hessenberg_Form_Elementary: (S)\r\n";
    print_matrix_h(S, n, n);
    std::cout << "\r\n";
   ...
   std::cout << "before Hessenberg_Elementary_Transform: (A)\r\n";
   print_matrix_h(A, n, n);
   std::cout << "\r\n";

   std::cout << "before Hessenberg_Elementary_Transform: (S)\r\n";
   print_matrix_h(S, n, n);
   std::cout << "\r\n";

   Hessenberg_Elementary_Transform(A, S, perm, n);

   std::cout << "after Hessenberg_Form_Elementary: (A)\r\n";
   print_matrix_h(A, n, n);
   std::cout << "\r\n";

   std::cout << "after Hessenberg_Form_Elementary: (S)\r\n";
   print_matrix_h(S, n, n);
   std::cout << "\r\n";
