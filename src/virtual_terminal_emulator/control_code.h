...
template <>
struct numeric_limits<vte::ControlCode::C0>
{
...
template <>
struct numeric_limits<vte::ControlCode::C1_7bit>
{
...
template <>
struct numeric_limits<vte::ControlCode::C1_8bit>
{
