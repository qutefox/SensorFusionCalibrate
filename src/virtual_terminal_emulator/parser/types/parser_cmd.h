...
_VTE_CMD(DECREQTPARM_OR_WYCDIR) /* request terminal parameters or set current character attributes */
...
_VTE_CMD(DECSLPP_OR_XTERM_WM) /* set lines per page or xterm window management */
...
_VTE_CMD(VT) /* vertical tag */
_VTE_CMD(XTERM_RPM) /* xterm restore DEC private mode */
_VTE_CMD(XTERM_SHIFTESCAPE) /* xterm set shift-escape */
_VTE_CMD(XTERM_SMGRAPHICS) /* xterm graphics attributes */
_VTE_CMD(XTERM_SPM) /* xterm save private mode */
...
_VTE_NOP(DECFNK) /* dec function key / XTERM bracketed paste */
...
_VTE_NOP(DECSGR) /* DEC select graphics rendition */
...
_VTE_NOP(DOCS) /* designate other coding system */
...
_VTE_NOP(EPA) /* end of protected area */
_VTE_NOP(ESA) /* end of selected area */
_VTE_NOP(ETB) /* end of transmissionblock */
...
_VTE_NOP(GnDMm) /* Gn designate multibyte 9m charset */
...
_VTE_NOP(MINTTY_PROGRESS) /* set progress report */
...
_VTE_NOP(WYCDIR) /* set current character attributes */
...
_VTE_NOP(XTERM_GETXRES) /* xterm get X resource */
_VTE_NOP(XTERM_IHMT) /* xterm initiate highlight mouse tracking */
_VTE_NOP(XTERM_MLHP) /* xterm memory lock hp bugfix */
_VTE_NOP(XTERM_MODKEYS) /* xterm set key modifier options */
_VTE_NOP(XTERM_MUHP) /* xterm memory unlock hp bugfix */
_VTE_NOP(XTERM_POPCOLORS) /* xterm pop color palette stack */
_VTE_NOP(XTERM_POPSGR) /* xterm pop SGR stack */
_VTE_NOP(XTERM_PTRMODE) /* xterm set pointer mode */
_VTE_NOP(XTERM_PUSHCOLORS) /* xterm push color palette stack */
_VTE_NOP(XTERM_PUSHSGR) /* xterm push SGR stack */
_VTE_NOP(XTERM_REPORTCOLORS) /* xterm Report color palette stack */
_VTE_NOP(XTERM_REPORTSGR) /* xterm SGR report */
